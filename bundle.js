...
`.extend({renderChildren:function(){return this.options.type?null:this.options.renderChildren?this.options.renderChildren():this.partial`
        ...
        `}}),Y=e=>({fontFamily:`var(--rui-typography-${e}-fontFamily)`,fontWeight:`var(--rui-typography-${e}-fontWeight)`,fontSize:`var(--rui-typography-${e}-fontSize)`,lineHeight:`var(--rui-typography-${e}-lineHeight)`}),G=U({root:{color:"var(--rui-palette-neutral-foregroundLevel1)",margin:"var(--rui-spacing-md) 0"},h1:Y("h1"),h2:Y("h2"),h3:Y("h3"),h4:Y("h4"),titleLg:Y("titleLg"),titleMd:Y("titleMd"),titleSm:Y("titleSm"),bodyLg:Y("bodyLg"),bodyMd:Y("bodyMd"),bodySm:Y("bodySm"),caption:Y("caption")}),X=e=>{switch(e.level){case"h1":return"h1";case"h2":case"titleLg":case"titleMd":case"titleSm":return"h2";case"h3":return"h3";case"h4":return"h4";default:return"p"}},q=C.create`
...
`,{classes:ee}=U({root:{display:"flex",justifyContent:"center",alignItems:"center",height:"100vh",flexDirection:"column",backgroundColor:"var(--rui-palette-neutral-backgroundLevel3)",boxShadow:"var(--rui-shadow-xs)",padding:"0 var(--rui-spacing-xl)",overflow:"hidden","@global":{h1:{textAlign:"center",margin:"var(--rui-app-appBarHeight) 0 0 0"},h2:{color:"var(--rui-palette-neutral-foregroundLevel2)",marginTop:0,marginBottom:"var(--rui-spacing-sm)"},h4:{color:"var(--rui-palette-neutral-foregroundLevel3)",marginBottom:"var(--rui-spacing-md)"},"h1 img":{width:"90%"},pre:{maxWidth:"100%"},code:{borderRadius:"var(--rui-borderRadius-sm)",boxShadow:"var(--rui-shadow-sm)",display:"block",background:"#282c34",color:"#abb2bf",overflowX:"auto",padding:"1em"}}},buttons:{"& a":{margin:"var(--rui-spacing-md) var(--rui-spacing-xs)"},display:"flex",justifyContent:"center"},[z("sm")]:{"$root h1":{margin:"var(--rui-app-appBarHeight) 0 0 0"},"$root h2":{marginBottom:"var(--rui-spacing-xl)"},"$root h4":{marginBottom:"var(--rui-spacing-xxl)"},"$root h1 img":{width:"75%"},"$buttons a":{margin:"var(--rui-spacing-xxxl) var(--rui-spacing-lg)"}},icon:{width:"24px",height:"24px",fill:"var(--rui-palette-secondary-main)"},hiddenIfLight:{display:"var(--rui-app-hiddenIfLight)"},hiddenIfDark:{display:"var(--rui-app-hiddenIfDark)"}}),te=C.create`
    <section class="${ee.root}">
        ...
        <div class="${ee.buttons}">
            ${()=>Z.mount({label:"Getting Started",color:"primary",variant:"outlined",href:"#gettingstarted"})}
            ${()=>Z.mount({label:"GitHub",color:"secondary",variant:"outlined",href:"https://github.com/8tentaculos/rasti",target:"_blank",renderLeftIcon:()=>J.mount({className:ee.icon})})}
        </div>
    </section>
`,{classes:ne}=U({root:{display:"flex",justifyContent:"center",alignItems:"center",flexDirection:"column",padding:"var(--rui-spacing-lg)",margin:"0 auto",maxWidth:"var(--rui-app-maxWidth)"}}),oe=C.create`
    <div class="${ne.root}">
        ${e=>q.mount({level:"h4",renderChildren:()=>e.partial`<strong>Rasti</strong> is a lightweight MVC library for building fast, reactive user interfaces.<br> Inspired by <strong>Backbone.js</strong>, it retains a familiar API while removing non-essential features and introducing modern, declarative, and composable components to simplify complex UI development.`})}
    </div>
`,ie=e=>e.charAt(0).toUpperCase()+e.slice(1),re=U({root:{borderRadius:"var(--rui-borderRadius-xs)",padding:"var(--rui-spacing-md)",backgroundColor:"var(--rui-palette-neutral-backgroundLevel2)",fontFamily:"var(--rui-fontFamily-body)",fontSize:"var(--rui-fontSize-bodyMd)"},...B((e=>({[e]:{color:`var(--rui-palette-${e}-foregroundMain)`}}))),outlined:{...B((e=>({[`&$${e}`]:{border:`1px solid rgb(var(--rui-palette-${e}-rgb-level1) / 0.4)`}})))},solid:{...B((e=>({[`&$${e}`]:{backgroundColor:`var(--rui-palette-${e}-main)`,color:`var(--rui-palette-${e}-contrastMain)`}})))},...D((e=>({[`shadow${ie(e)}`]:{boxShadow:`var(--rui-shadow-${e})`}})))}),ae=C.create`
    <div class="${({options:e})=>(e=>{const t=e.classes?{...re.classes,...e.classes}:re.classes;return[e.className||null,t.root,t[e.variant||"outlined"],t[e.color||"neutral"],e.shadow?t[`shadow${ie(e.shadow)}`]:null].join(" ")})(e)}">
...
`,ce=C.create`
    <div class="${({options:e})=>ue(e).content}">
        ${({options:e})=>e.renderChildren&&e.renderChildren()}
    </div>
`,he=C.create`
    <div class="${({options:e})=>ue(e).footer}">
        ${({options:e})=>e.renderChildren&&e.renderChildren()}
    </div>
`,ue=e=>e.classes?{...de.classes,...e.classes}:de.classes,pe=({variant:e,color:t,shadow:n})=>({variant:e,color:t,shadow:n}),ge=C.create`
    <div
        class="${({options:e})=>(e=>{const t=ue(e);return[e.className||null,t.root,e.top?t.top:null,e.bottom?t.bottom:null,e.left?t.left:null,e.right?t.right:null].join(" ")})(e)}"
        onClick=${{"&":function(e){this.options.handleClose&&e.target===this.el&&this.options.handleClose()}}}
    >
        <${ae} ${({options:e})=>({...pe(e),className:ue(e).modal,tag:"div"})}>
            ${e=>e.renderContent()}
        </${ae}>
    </div>
`.extend({renderContent(){return this.options.renderChildren?this.options.renderChildren():this.partial`
            ${this.options.handleClose?this.partial`<${le} ${{...this.options}} />`:null}
            ...
            ${this.options.renderButtons?this.partial`
                    ...
                    `:null}
        `}});ge.Header=le,ge.Content=ce,ge.Footer=he;var me=C.create`
    <svg class="${({options:e})=>e.className}" width="20" height="20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" data-slot="icon">
...
`;const{classes:ve}=U({root:{display:"flex",justifyContent:"right",alignItems:"center",height:"60px","& ul":{padding:0}},icon:{width:"24px",height:"24px",cursor:"pointer",fill:"var(--rui-palette-neutral-main)","&:hover":{fill:"var(--rui-palette-neutral-dark)"}},hiddenIfLight:{display:"var(--rui-app-hiddenIfLight)"},hiddenIfDark:{display:"var(--rui-app-hiddenIfDark)"}}),ye=C.create`
    <div class="${ve.root}">
        <ul>
            <li class="${ve.hiddenIfDark}">
                ${()=>Z.mount({variant:"plain",renderChildren:()=>fe.mount({className:ve.icon}),onClick:()=>document.documentElement.setAttribute("data-color-scheme","dark")})}
            </li>
            <li class="${ve.hiddenIfLight}">
                ${()=>Z.mount({variant:"plain",renderChildren:()=>be.mount({className:ve.icon}),onClick:()=>document.documentElement.setAttribute("data-color-scheme","light")})}
            </li>
        </ul>
    </div>
`,{classes:_e}=U({root:{display:"flex",alignItems:"center",justifyContent:"space-between",height:"var(--rui-app-appBarHeight)",position:"fixed",top:0,left:0,right:0,backgroundColor:"var(--rui-palette-neutral-backgroundLevel2)",boxShadow:"var(--rui-shadow-sm)","& nav":{maxWidth:"100%",display:"flex",justifyContent:"flex-end",alignItems:"center","& ul":{display:"flex",justifyContent:"center",alignItems:"center",listStyle:"none",padding:0,"& li":{margin:"0 var(--rui-spacing-xs)"}}},"& nav$left":{flexGrow:1,justifyContent:"flex-start","& ul":{justifyContent:"flex-start"}},"& nav$lg":{display:"none"}},[z("sm")]:{"$root nav$lg":{display:"flex"},"$root li$sm":{display:"none"}},left:{},sm:{},lg:{},icon:{width:"24px",height:"24px",fill:"var(--rui-palette-neutral-main)","a:hover &":{fill:"var(--rui-palette-neutral-dark)"}},hiddenIfLight:{display:"var(--rui-app-hiddenIfLight)"},hiddenIfDark:{display:"var(--rui-app-hiddenIfDark)"},menuContent:{"& nav":{maxWidth:"100%",display:"flex",justifyContent:"flex-end",alignItems:"center","& ul":{display:"flex",justifyContent:"center",flexDirection:"column",alignItems:"center",listStyle:"none",padding:0,"& li":{margin:"var(--rui-spacing-md)"}}}}}),we=C.create`
    <div class="${_e.menuContent}">
        ${({options:e,partial:t})=>t`
            <nav><ul>
                <li>
                    <${Z} ${{href:"/api/",onClick:t=>{t.preventDefault(),e.handleNavigate("/api/"),e.handleOpen(!1)},label:"API",variant:"plain",size:"lg"}} />
                </li>
                <li>
                    <${Z} ${{href:"https://codepen.io/8tentaculos/pen/gOQxaOE?editors=0010",onClick:t=>{e.handleOpen(!1)},target:"_blank",label:"Playground",variant:"plain",size:"lg"}} />
                </li>
                <li>
                    <${Z} ${{href:"https://github.com/8tentaculos/rasti",onClick:t=>{e.handleOpen(!1)},target:"_blank",label:"GitHub",variant:"plain",size:"lg",renderLeftIcon:()=>J.mount({className:_e.icon})}} />
                </li>
                <li>
                    <${Z} ${{href:"https://www.npmjs.com/package/rasti",onClick:t=>{e.handleOpen(!1)},target:"_blank",label:"npm",variant:"plain",size:"lg",renderLeftIcon:()=>Q.mount({className:_e.icon})}} />
                </li>
            </ul></nav>
        `}
    </div>
`,xe=C.create`
    <div class="">
        ${({options:e})=>Z.mount({renderChildren:()=>me.mount({className:_e.icon}),color:"primary",variant:"plain",size:"lg",onClick:()=>e.handleOpen(!0)})}
        ${({options:e})=>e.open?ge.mount({handleClose:()=>e.handleOpen(!1),renderContent:e.renderContent,shadow:"lg"}):null}
    </div>
`,Ee=C.create`
    <div class="${_e.root}">
        <nav class="${_e.left}">
            <ul>
                <li>
                    ${e=>Z.mount({href:"/",onClick:t=>{t.preventDefault(),e.options.handleNavigate("/")},variant:"plain",renderChildren:()=>e.partial`
                            <span>
                                <img height="24" class="${_e.hiddenIfLight}" alt="Rasti.js" src="/logo-dark.svg">
                                <img height="24" class="${_e.hiddenIfDark}" alt="Rasti.js" src="/logo.svg">
                            </span>
                        `})}
                </li>
            </ul>
        ...
        <nav class="${_e.lg}">
            <ul>
                <li>
                    ${({options:e})=>Z.mount({href:"/api/",onClick:t=>{t.preventDefault(),e.handleNavigate("/api/")},label:"API",variant:"plain"})}
                </li>
                <li>
                    ${()=>Z.mount({href:"https://codepen.io/8tentaculos/pen/gOQxaOE?editors=0010",target:"_blank",label:"Playground",variant:"plain"})}
                </li>
                <li>
                    ${()=>Z.mount({href:"https://github.com/8tentaculos/rasti",target:"_blank",variant:"plain",renderChildren:()=>J.mount({className:_e.icon})})}
                </li>
                <li>
                    ${()=>Z.mount({href:"https://www.npmjs.com/package/rasti",target:"_blank",variant:"plain",renderChildren:()=>Q.mount({className:_e.icon})})}
                </li>
            </ul>
        </nav>
        <nav>
...
<p>A DOM-based remake of the classic Ms. Pac-Man game. <strong>Rasti</strong> powers its custom game engine.  </p></section>
        `,je=e=>({fontFamily:`var(--rui-typography-${e}-fontFamily)`,fontWeight:`var(--rui-typography-${e}-fontWeight)`,fontSize:`var(--rui-typography-${e}-fontSize)`,lineHeight:`var(--rui-typography-${e}-lineHeight)`}),{classes:Te}=U({root:{fontFamily:"var(--rui-fontFamily-body)",fontWeight:"var(--rui-fontWeight-xs)",fontSize:"var(--rui-fontSize-md)",lineHeight:"var(--rui-lineHeight-md)",padding:"var(--rui-spacing-lg)",margin:"0 auto",maxWidth:"var(--rui-app-maxWidth)",color:"var(--rui-palette-neutral-foregroundLevel2)","@global":{h1:{fontFamily:"var(--rui-fontFamily-body)",fontWeight:"var(--rui-fontWeight-xl)",fontSize:"var(--rui-fontSize-xxxl)",lineHeight:"var(--rui-lineHeight-xs)",color:"var(--rui-palette-neutral-foregroundLevel1)",margin:"var(--rui-spacing-lg) 0"},h2:{fontFamily:"var(--rui-fontFamily-body)",fontWeight:"var(--rui-fontWeight-xl)",fontSize:"var(--rui-fontSize-xxl)",lineHeight:"var(--rui-lineHeight-xs)",color:"var(--rui-palette-neutral-foregroundLevel1)",margin:"var(--rui-spacing-lg) 0",padding:"var(--rui-spacing-sm) 0",borderBottom:"1px solid rgba(var(--rui-palette-neutral-rgb-foregroundLevel1) / 0.2)"},h3:{fontFamily:"var(--rui-fontFamily-body)",fontWeight:"var(--rui-fontWeight-lg)",fontSize:"var(--rui-fontSize-xl)",lineHeight:"var(--rui-lineHeight-xs)",color:"var(--rui-palette-neutral-foregroundLevel2)",margin:"var(--rui-spacing-lg) 0",overflowY:"hidden",overflowX:"auto"},h4:{fontFamily:"var(--rui-fontFamily-body)",fontWeight:"var(--rui-fontWeight-lg)",fontSize:"var(--rui-fontSize-lg)",lineHeight:"var(--rui-lineHeight-md)",color:"var(--rui-palette-neutral-foregroundLevel3)",margin:"var(--rui-spacing-lg) 0"},h5:{fontFamily:"var(--rui-fontFamily-body)",fontWeight:"var(--rui-fontWeight-md)",fontSize:"var(--rui-fontSize-xl)",lineHeight:"var(--rui-lineHeight-md)",color:"var(--rui-palette-neutral-foregroundLevel3)",margin:"var(--rui-spacing-lg) 0"},p:{fontFamily:"var(--rui-fontFamily-body)",fontWeight:"var(--rui-fontWeight-xs)",fontSize:"var(--rui-fontSize-md)",lineHeight:"var(--rui-lineHeight-md)",color:"var(--rui-palette-neutral-foregroundLevel2)",margin:"var(--rui-spacing-lg) 0"},li:{fontFamily:"var(--rui-fontFamily-body)",fontWeight:"var(--rui-fontWeight-xs)",fontSize:"var(--rui-fontSize-md)",lineHeight:"var(--rui-lineHeight-md)",color:"var(--rui-palette-neutral-foregroundLevel2)",margin:"var(--rui-spacing-lg) 0"},"li::marker":{color:"var(--rui-palette-neutral-foregroundLevel3)"},"pre > code":{borderRadius:"var(--rui-borderRadius-sm)",boxShadow:"var(--rui-shadow-sm)",display:"block",background:"#282c34",color:"#abb2bf",overflowX:"auto",padding:"1em"},a:{color:"var(--rui-palette-primary-foregroundMain)",textDecoration:"none","&:visited, &:active":{color:"var(--rui-palette-primary-foregroundMain)"},"&:hover":{textDecoration:"underline",color:"var(--rui-palette-primary-foregroundDark)"}},table:{color:"var(--rui-palette-neutral-foregroundLevel1)",display:"block",overflowX:"auto",borderCollapse:"collapse","& th":{borderColor:"rgb(var(--rui-palette-neutral-rgb-foregroundLevel3) / 0.2)",borderStyle:"none",padding:"var(--rui-spacing-sm) var(--rui-spacing-md)",...je("titleMd"),"& div":{display:"flex",alignItems:"center",justifyContent:"space-evenly"},"& svg:first-child":{padding:"0 var(--rui-spacing-xs) 0 0"},"& svg:last-child":{padding:"0 0 0 var(--rui-spacing-xs)"},"& svg:only-child":{padding:"0"}},"& td":{borderColor:"rgb(var(--rui-palette-neutral-rgb-foregroundLevel3) / 0.2)",borderStyle:"none",padding:"var(--rui-spacing-sm) var(--rui-spacing-md)",...je("bodyMd")},"& thead th, & thead td":{borderBottomStyle:"solid",borderBottomWidth:"2px"},"& tfoot th, & tfoot td":{borderTopStyle:"solid",borderTopWidth:"2px"},"& tr:not(:last-child) td":{borderBottomStyle:"solid",borderBottomWidth:"1px"},"& td:not(:last-child), & th:not(:last-child)":{borderRightStyle:"solid",borderRightWidth:"1px"}}},marginTop:"var(--rui-app-appBarHeight)"}}),Ae=C.create`
            <section class="${({options:e})=>(e=>[e.className||null,Te.root].join(" "))(e)}"><h2 id="modules">Modules</h2>
<ul>
...
<li><a href="#module_component__destroy">.destroy(options)</a> ⇒ <code>Rasti.View</code></li>
...
<li><a href="#module_component__partial">.partial(strings, …expressions)</a> ⇒ <code>Array</code></li>
<li><a href="#module_component__render">.render()</a> ⇒ <code>Rasti.Component</code></li></ul></li>
<li><em>static</em><ul>
...
<h2 id="componentc23c">Component ⇐ <code>Rasti.View</code></h2>
...
<h3 id="componentsubscribemodelc37c">component.subscribe(model) ⇒ <code>Rasti.Component</code></h3>
...
<p><a name="module_component__destroy" id="module_component__destroy" class="anchor"></a></p>
<h3 id="componentdestroyoptionsc41c">component.destroy(options) ⇒ <code>Rasti.View</code></h3>
<p>Destroy the <code>Component</code>.
Destroy children components if any, undelegate events, stop listening to events, call <code>onDestroy</code> lifecycle method.</p>
<p><strong>Kind</strong>: instance method of <a href="#module_component"><code>Component</code></a><br />
...
<p>Lifecycle method. Called after the component is rendered.</p>
<ul>
<li>When the component is rendered for the first time, this method is called with <code>Component.RENDER_TYPE_HYDRATE</code> as the argument.</li>
<li>When the component is updated or re-rendered, this method is called with <code>Component.RENDER_TYPE_RENDER</code> as the argument.</li>
<li>When the component is recycled (reused with the same key), this method is called with <code>Component.RENDER_TYPE_RECYCLE</code> as the argument.</li>
</ul>
<p><strong>Kind</strong>: instance method of <a href="#module_component"><code>Component</code></a>  </p>
<table>
<thead>
...
<td>type</td>
<td><code>string</code></td>
<td>The render type. Possible values are: <code>Component.RENDER_TYPE_HYDRATE</code>, <code>Component.RENDER_TYPE_RENDER</code> and <code>Component.RENDER_TYPE_RECYCLE</code>.</td>
</tr>
</tbody>
</table>
...
<h3 id="componentpartialstringsexpressionsc55c">component.partial(strings, …expressions) ⇒ <code>Array</code></h3>
...
<h3 id="componentrenderc60c">component.render() ⇒ <code>Rasti.Component</code></h3>
<p>Render the <code>Component</code>.  </p>
<ul>
<li>If <code>this.el</code> is not present, the <code>Component</code> will be rendered as a string inside a <code>DocumentFragment</code> and hydrated, making <code>this.el</code> available. The <code>onRender</code> lifecycle method will be called with <code>Component.RENDER_TYPE_HYDRATE</code> as an argument.  </li>
<li>If <code>this.el</code> is present, the method will update the attributes and inner HTML of the element, or recreate its child component in the case of a container. The <code>onRender</code> lifecycle method will be called with <code>Component.RENDER_TYPE_RENDER</code> as an argument.  </li>
<li>When rendering child components, if the new children have the same key as the previous ones, they will be recycled. A recycled <code>Component</code> will call the <code>onRender</code> lifecycle method with <code>Component.RENDER_TYPE_RECYCLE</code> as an argument.  </li>
<li>If the active element is inside the component, it will retain focus after the render.</li>
</ul>
<p><strong>Kind</strong>: instance method of <a href="#module_component"><code>Component</code></a><br />
<strong>Returns</strong>: <code>Rasti.Component</code> - The component instance.<br />
<a name="module_component_markassafehtml" id="module_component_markassafehtml" class="anchor"></a></p>
<h3 id="componentmarkassafehtmlvaluec63c">Component.markAsSafeHTML(value) ⇒ <code>Rasti.SafeHTML</code></h3>
...
<h3 id="componentmountoptionselhydratec69c">Component.mount(options, el, hydrate) ⇒ <code>Rasti.Component</code></h3>
...
<h3 id="componentcreatestringsexpressionsc74c">Component.create(strings, …expressions) ⇒ <code>Rasti.Component</code></h3>
...
<h2 id="modelc92c">Model ⇐ <code>Rasti.Emitter</code></h2>
<ul>
...
<h3 id="modelgetkeyc106c">model.get(key) ⇒ <code>any</code></h3>
...
<h3 id="modelsetkeyvaluec110c">model.set(key, [value]) ⇒ <code>this</code></h3>
...
<h3 id="modeltojsonc116c">model.toJSON() ⇒ <code>object</code></h3>
...
<h2 id="viewc119c">View ⇐ <code>Emitter</code></h2>
<ul>
...
<h3 id="viewdselectorc146c">view.\$(selector) ⇒ <code>node</code></h3>
...
<p><a name="module_view__\$\$" id="module_view__\$\$" class="anchor"></a></p>
<h3 id="viewddselectorc150c">view.\$\$(selector) ⇒ <code>Array.&lt;node&gt;</code></h3>
...
<h3 id="viewdestroyoptionsc154c">view.destroy(options) ⇒ <code>Rasti.View</code></h3>
<p>Destroy the view.
...
<h3 id="viewaddchildchildc160c">view.addChild(child) ⇒ <code>Rasti.View</code></h3>
...
<h3 id="viewcreateelementtagattributesc165c">view.createElement(tag, attributes) ⇒ <code>node</code></h3>
<p>Create an element.
...
<h3 id="viewremoveelementc171c">view.removeElement() ⇒ <code>Rasti.View</code></h3>
...
<h3 id="viewdelegateeventseventsc174c">view.delegateEvents([events]) ⇒ <code>Rasti.View</code></h3>
...
<h3 id="viewundelegateeventsc178c">view.undelegateEvents() ⇒ <code>Rasti.View</code></h3>
...
<h3 id="viewrenderc181c">view.render() ⇒ <code>Rasti.View</code></h3>
...
<h3 id="viewsanitizestrc184c">View.sanitize(str) ⇒ <code>string</code></h3>
...
<td>String to escape.</td>
        ...
        `,{classes:Me}=U({root:{display:"flex",justifyContent:"center",alignItems:"center",flexDirection:"column",padding:"var(--rui-spacing-xl) 0 var(--rui-spacing-xxxxl) 0",borderTop:"1px solid rgb(var(--rui-palette-neutral-rgb-foregroundLevel1) / 0.2)",backgroundColor:"var(--rui-palette-neutral-backgroundLevel2)","@global":{a:{color:"var(--rui-palette-neutral-main)",textDecoration:"none","&:visited, &:active":{color:"var(--rui-palette-neutral-main)"},"&:hover":{textDecoration:"underline",color:"var(--rui-palette-neutral-dark)"}}}},text:{color:"var(--rui-palette-neutral-foregroundLevel3)"}}),Ne=C.create`
    <footer class="${Me.root}">
        ${e=>q.mount({level:"titleMd",className:Me.text,renderChildren:()=>e.partial`Released under the <a href="https://github.com/8tentaculos/rasti/blob/master/LICENSE" target="_blank">MIT License</a>`})}
        ${e=>q.mount({level:"titleSm",className:Me.text,renderChildren:()=>e.partial`Copyright © ${(()=>{const e=(new Date).getFullYear();return 2018===e?e:`2018-${e}`})()} <a href="https://github.com/8tentaculos" target="_blank">8tentaculos</a>`})}
    </footer>
`,{classes:Oe}=U({"@global":{body:{margin:0,backgroundColor:"var(--rui-palette-neutral-backgroundLevel1)"},"a.anchor, h2":{scrollMarginTop:"var(--rui-app-appBarHeight)"}},root:{}}),De=(e="")=>{const t=e.match(/\/([^/]+)\//),n=t?t[1]:e;return["api"].includes(n)?n:""};C.create`
    <div class="${Oe.root}">
        ${e=>Ee.mount({handleNavigate:e.navigate.bind(e)})}

        ${({state:e})=>"api"===e.route?Ae.mount():[te.mount(),oe.mount(),ke.mount(),Le.mount()]}

        ${()=>Ne.mount()}
    </div>
`.extend({preinitialize(e={}){this.state=new u({route:De(e.route)}),"undefined"!=typeof window&&(window.history.replaceState({route:this.state.route},""),window.addEventListener("popstate",(e=>{e.state&&(this.state.route=De(e.state.route))})))},navigate(e){this.state.route=De(e),window.history.pushState({route:this.state.route},"",this.state.route?`/${this.state.route}/`:"/"),document.title=this.getTitle(),window.scrollTo(0,0)},getTitle(){return"Rasti.js"+("api"===this.state.route?" - API Documentation":"")}}).mount({route:window.location.pathname,onRender:t=>{e.highlightAll()}},document.getElementById("root"),!0)})()})();