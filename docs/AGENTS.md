...
**Key Methods:**
- [`Component.create`](https://cdn.jsdelivr.net/gh/8tentaculos/rasti@v4.1.2/docs/api.md#module_component_create) — creates component class from template
...
[`partial`](https://cdn.jsdelivr.net/gh/8tentaculos/rasti@v4.1.2/docs/api.md#module_component__partial) creates sub-templates for conditional blocks and lists, preserving component recycling by position.
