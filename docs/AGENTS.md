...
For detailed API documentation, see: [API Documentation](https://cdn.jsdelivr.net/gh/8tentaculos/rasti@v4.0.0-alpha.9/docs/api.md)
...
**Key Methods:**
- [`Component.create`](https://cdn.jsdelivr.net/gh/8tentaculos/rasti@v4.0.0-alpha.9/docs/api.md#module_component_create) - Creates a new component class from a template
- [`Component.mount`](https://cdn.jsdelivr.net/gh/8tentaculos/rasti@v4.0.0-alpha.9/docs/api.md#module_component_mount) - Creates and mounts a component instance
- [`Component.extend`](https://cdn.jsdelivr.net/gh/8tentaculos/rasti@v4.0.0-alpha.9/docs/api.md#module_component_extend) - Extends a component with additional methods
...
**Key Properties:**
- `this.props` - [Model](https://cdn.jsdelivr.net/gh/8tentaculos/rasti@v4.0.0-alpha.9/docs/api.md#module_model) containing props passed from parent
- `this.model` - [Model](https://cdn.jsdelivr.net/gh/8tentaculos/rasti@v4.0.0-alpha.9/docs/api.md#module_model) for application data
- `this.state` - [Model](https://cdn.jsdelivr.net/gh/8tentaculos/rasti@v4.0.0-alpha.9/docs/api.md#module_model) for internal component state
...
The [`partial`](https://cdn.jsdelivr.net/gh/8tentaculos/rasti@v4.0.0-alpha.9/docs/api.md#module_component__partial) method creates sub-templates that preserve DOM structure for efficient recycling.
...
**Related:** [`Component.markAsSafeHTML`](https://cdn.jsdelivr.net/gh/8tentaculos/rasti@v4.0.0-alpha.9/docs/api.md#module_component_markassafehtml)
...
**Related API:**
- [`component.onCreate`](https://cdn.jsdelivr.net/gh/8tentaculos/rasti@v4.0.0-alpha.9/docs/api.md#module_component__oncreate)
- [`component.onChange`](https://cdn.jsdelivr.net/gh/8tentaculos/rasti@v4.0.0-alpha.9/docs/api.md#module_component__onchange)
- [`component.onHydrate`](https://cdn.jsdelivr.net/gh/8tentaculos/rasti@v4.0.0-alpha.9/docs/api.md#module_component__onhydrate)
- [`component.onBeforeUpdate`](https://cdn.jsdelivr.net/gh/8tentaculos/rasti@v4.0.0-alpha.9/docs/api.md#module_component__onbeforeupdate)
- [`component.onUpdate`](https://cdn.jsdelivr.net/gh/8tentaculos/rasti@v4.0.0-alpha.9/docs/api.md#module_component__onupdate)
- [`component.onBeforeRecycle`](https://cdn.jsdelivr.net/gh/8tentaculos/rasti@v4.0.0-alpha.9/docs/api.md#module_component__onbeforerecycle)
- [`component.onRecycle`](https://cdn.jsdelivr.net/gh/8tentaculos/rasti@v4.0.0-alpha.9/docs/api.md#module_component__onrecycle)
- [`component.onDestroy`](https://cdn.jsdelivr.net/gh/8tentaculos/rasti@v4.0.0-alpha.9/docs/api.md#module_component__ondestroy)
...
**Related API:**
- [`component.subscribe`](https://cdn.jsdelivr.net/gh/8tentaculos/rasti@v4.0.0-alpha.9/docs/api.md#module_component__subscribe) - Subscribe to model 'change' events
- [`Emitter.listenTo`](https://cdn.jsdelivr.net/gh/8tentaculos/rasti@v4.0.0-alpha.9/docs/api.md#module_emitter__listento) - Subscribe to custom events
- [`Model`](https://cdn.jsdelivr.net/gh/8tentaculos/rasti@v4.0.0-alpha.9/docs/api.md#module_model) - Data model class

### Rendering

The [`render()`](https://cdn.jsdelivr.net/gh/8tentaculos/rasti@v4.0.0-alpha.9/docs/api.md#module_component__render) method handles both initial render and updates:
...
- **Full API Documentation**: [api.md](https://cdn.jsdelivr.net/gh/8tentaculos/rasti@v4.0.0-alpha.9/docs/api.md)
