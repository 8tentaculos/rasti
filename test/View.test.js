...
describe('View', () => {
    ...
    describe('Element creation and attributes', () => {
    ...
    describe('Event delegation', () => {
        ...
        it('must handle function and string event handlers', (done) => {
            let eventsOrder = [];
            ...
            class TestView extends View {
                ...
                handleClick() {
                    eventsOrder.push('method-click');
                }

                handleMouseOut() {
                    eventsOrder.push('method-out');
                    if (eventsOrder.length === 3) {
                        expect(eventsOrder).to.deep.equal(['method-click', 'function-hover', 'method-out']);
                        done();
                    }
                }
            }

            TestView.prototype.template = () => '<div><button>mixed events</button></div>';
