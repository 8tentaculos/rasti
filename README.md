...
It's ideal for building simple lightweight applications, without the need of config or boilerplate. Where a resulting small codebase is prioritized instead of featuring a complex rendering system.<br />
