...
/**
 * The live state of a bare expression, paired by position with the `ExpressionDescriptor`
 ...
 * @param {ExpressionDescriptor} descriptor The expression reference this slot renders from.
 * @private
 */
